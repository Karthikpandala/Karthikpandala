...
const Portfolio = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center">
        <LoadingSpinner size="large" message="Loading your portfolio..." />
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-slate-50 flex items-center justify-center px-6">
        <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full text-center">
          ...
          <p className="text-slate-600 mb-4">
            {error || 'There was an error loading the portfolio data.'}
          </p>
          <Button
  ...
  const { profile, skills, projects, certificates, education } = data;

  if (!profile) {
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center">
        <LoadingSpinner size="large" message="Loading profile data..." />
      </div>
    );
  }
            ...
            <div className="flex flex-col md:flex-row items-center gap-12">
              ...
              <div className="flex-shrink-0">
                <div className="w-80 h-80 rounded-full overflow-hidden bg-gradient-to-br from-blue-400 to-blue-600 p-2">
                  <img
                    src={profile.profile_image_url || "/api/placeholder/400/400"}
                    alt="Karthik Pandala"
            ...
            <div className="container mx-auto max-w-6xl">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {certificates.map((cert) => (
                  <Card key={cert.id} className="bg-white border-slate-200 hover:shadow-lg transition-shadow">
                    <CardContent className="p-6">
          ...
          <section className="py-20 px-6 bg-white">
            <div className="container mx-auto max-w-4xl">
              ...
              <div className="space-y-8">
                {education.map((edu) => (
                  <Card key={edu.id} className="bg-slate-50 border-slate-200">
                    <CardContent className="p-6">
                      <div className="flex items-start gap-4">
                        <div className="p-3 bg-blue-100 rounded-lg flex-shrink-0">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <Card className="bg-slate-800 border-slate-700">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-slate-300">{profile.contact.email}</p>
                </CardContent>
              </Card>
              <Card className="bg-slate-800 border-slate-700">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-slate-300">{profile.contact.phone}</p>
                </CardContent>
              </Card>
            </div>
